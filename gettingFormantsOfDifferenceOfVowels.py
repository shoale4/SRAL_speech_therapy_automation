...
# -*- coding: utf-8 -*-
"""
Created on Mon Aug 16 10:50:32 2021
...
def gettingFormantsOfDifferenceOfVowels(fft_difference):
    ...
    fft_out = fft_out[0:len(fft_forAdding_scaled)]
    fft_studentPlusError = fft_forAdding_scaled + fft_out
